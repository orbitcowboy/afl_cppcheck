...
cp -f ${WORKINGDIR}/afl-output/crashes/* ${WORKINGDIR}/crashes/.
...
j=0; for i in *.c ; do let j+=1 ; ${WORKINGDIR}/afl/afl-tmin -t 5000 -i $i -o r$i -- ../cppcheck/cppcheck --enable=all --inconclusive @@ ; done
# cleanup
rm crash*.c
